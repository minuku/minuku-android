...
public class ReportPage extends AppCompatActivity {
    ...
    final private String TAG = "ReportPage";
...
/*
    ...
    private Button.OnClickListener choosingstartdate = new Button.OnClickListener(){
        public void onClick(View v){
            ...
            new DatePickerDialog(ReportPage.this, new DatePickerDialog.OnDateSetListener() {
                @Override
...
*/
    ...
    public void datediff_valid(String FD, String SD) {
        ...
        if(FD.equals("請選擇日期")||SD.equals("請選擇日期"))
            Toast.makeText(ReportPage.this,"請選擇日期",Toast.LENGTH_SHORT).show();
        else{
            try{
                long diff = 0;
                ...
                diff = end - start;
                if(diff<0)
                    Toast.makeText(ReportPage.this,"請調整日期範圍",Toast.LENGTH_SHORT).show();
                else{
                    Log.d(TAG,"創建報告 CSV檔");
                    //TODO 創建報告 CSV檔
                }
