...
//                    String.valueOf( new AppUsageDataRecord(Screen_Status,mLastestForegroundPackage,mLastestForegroundActivity).getCurrentTimeInMillis() - mApplicaitonUsageSinceLastDurationInMilliseconds)
//                    + " and " + new AppUsageDataRecord().getCurrentTimeInMillis());
            ...
            appList = usm.queryUsageStats(UsageStatsManager.INTERVAL_DAILY,
                    //start time
                    new AppUsageDataRecord(Screen_Status,mLastestForegroundPackage,mLastestForegroundActivity).getCurrentTimeInMillis()- mApplicaitonUsageSinceLastDurationInMilliseconds,
                    //end time: until now
                    new AppUsageDataRecord(Screen_Status,mLastestForegroundPackage,mLastestForegroundActivity).getCurrentTimeInMillis());
    ...
    protected void getForegroundActivityBeforeAPI21(){
        ...
        if ( mActivityManager!=null){
            ...
            Log.d(TAG, "test app os version " + Build.VERSION.SDK_INT + " under 21 "
